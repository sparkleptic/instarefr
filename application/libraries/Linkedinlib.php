...
{
    /*
     *  LinkedIn Login Library file 
     *  Used to interact with LinkedIn login libraries.
     *  Get the LinkedIn login urls
     *  and LinkedIn User information. 
     *     
     */
    ...
    public function linkedinlogin($data = NULL)
    {
        try {
                ...
                $API_CONFIG = array(
                              'appKey'       => '781no8badn1ja5',
                              'appSecret'    => '85iC7XEBOo45XsaL',
                              'callbackUrl'  => '' 
                );
